        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative -mt-20">
          <div className="flex flex-col md:flex-row items-start gap-4">
            ...
            <div className="flex-1 pt-2">
              ...
              {/* Visibility Badge & Member Count - Metadata Container */}
              <div className="flex flex-wrap items-center gap-4 mt-4 mb-3">
                {/* Visibility Badge - Neon Style */}
                {groupData.visibilidad === 'Open' || groupData.visibilidad === 'public' ? (
                  ...
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider border bg-gray-500/10 border-gray-500 text-gray-300">
                    <Globe size={12} />
                    {groupData.visibilidad}
                  </span>
                )}
                
                {/* Member Count - Enhanced Visibility */}
                <span className="inline-flex items-center gap-2 text-sm font-medium text-gray-200">
                  <Users size={16} className="text-gray-300" />
                  {groupData.member_count?.toLocaleString() || '0'} miembros
                </span>
              </div>
              ...
              if (tab.id === 'discussions') {
                return (
                  <Link
                    ...
                    className="pb-3 text-sm font-medium transition-all text-gray-400 hover:text-white border-b-2 border-transparent hover:border-gray-600"
                  >
                    {tab.label}
                  </Link>
                );
